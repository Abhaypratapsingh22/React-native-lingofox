...
The code should be 6 digits, use the number pad, keep the modal above the keyboard. **Entering six digits submits the code to the authentication provider and navigates to / only after successful verification; on failure, show an invalid-code state and keep the modal open.**

...
- After Clerk authentication completes (sign-in or sign-up), call posthog.reset() whenever the session is signed out or user.id changes, before identifying the next user.

...
Core 3 minimums are `@clerk/nextjs` v7.5.2+, `@clerk/react` v6.9.1+, and `@clerk/expo` v3.4.2+. Use the Core 3 references for those versions; use the corresponding Core 2 references for older package versions.
...
| Custom sign-in (Core 3: @clerk/nextjs v7.5.2+, @clerk/react v6.9.1+, @clerk/expo v3.4.2+) | core-3/custom-sign-in.md |
| Custom sign-up (Core 3: @clerk/nextjs v7.5.2+, @clerk/react v6.9.1+, @clerk/expo v3.4.2+) | core-3/custom-sign-up.md |
...
**If the project uses shadcn/ui** (check for `components.json` in the project root), use the shadcn theme only after explicit user approval to install or use `@clerk/ui`:

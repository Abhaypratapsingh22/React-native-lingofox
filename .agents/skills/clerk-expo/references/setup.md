...
> Canonical doc (fetch to re-verify if the installed SDK is newer than 3.6.x): https://clerk.com/docs/quickstarts/expo (Expo SDK tab)
...
{
  "expo": {
    "plugins": ["expo-secure-store", "@clerk/expo", "@clerk/expo-google-signin"]
  }
}
```
